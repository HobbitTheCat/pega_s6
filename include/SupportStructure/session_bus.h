...
int send_user_message(bus_base_t* bus, uint32_t user_id, uint32_t user_fd,
    uint32_t session_id, uint8_t packet_type, uint16_t message_length, const uint8_t* buf);
